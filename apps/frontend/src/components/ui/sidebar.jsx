...
function Sidebar({
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-sidebar text-sidebar-foreground flex h-full flex-col p-1.5",
          className
        )}
  ...
  return (
    <div
      className="group peer text-sidebar-foreground hidden md:block p-2"
      data-state={state}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-side=right][data-collapsible=offcanvas]_&]:-left-2 p-2",
        className
      )}
      {...props} />
  );
  ...
  return (
    <div
      ...
      <Skeleton
        ...
        style={{ maxWidth: "var(--skeleton-width)", "--skeleton-width": width }}
